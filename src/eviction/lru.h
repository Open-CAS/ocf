...
void evp_lru_dirty_cline(struct ocf_cache *cache, struct ocf_part_runtime *part,
		uint32_t cline);
void evp_lru_clean_cline(struct ocf_cache *cache, struct ocf_part_runtime *part,
		uint32_t cline);
